...
public class AgregarTripulacion extends javax.swing.JFrame {
    
    private Tripulacion tripulante = new Tripulacion();
    public AgregarTripulacion() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Agregar Tripulacion - Sistema Aerolínea");
        ...
        jButton1.setText("Agregar Tripulación");
        ...
        jButton5.setText("Eliminar Tripulantes");
        ...
        jButton6.setText("Guardar Tripulantes");
        ...
        jLabel5.setText("Detalle de la Tripulación");
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/IconoTripulantes.jpg"))); // NOI18N
        ...
        jLabel6.setText("Bruno Rodriguez - Exámen Final");
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addGap(34, 34, 34)
                                        .addComponent(jNombre, javax.swing.GroupLayout.PREFERRED_SIZE, 238, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(layout.createSequentialGroup()
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        try {   
            tripulante.setNombre(jNombre.getText());
            tripulante.setValor_hora(Double.parseDouble(jValor.getText()));
            try{
                tripulante.Guardar();
            ...
            Logger.getLogger(AgregarTripulacion.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AgregarTripulacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AgregarTripulacion().setVisible(true);
            }
        });
    }
